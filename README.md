...
- MuJoCo, MuJoCo: A physics engine for model-based control (2012), [paper link](https://ieeexplore.ieee.org/abstract/document/6386109)
- RaiSim, Per-Contact Iteration Method for Solving Contact Dynamics (2018), [paper link](https://ieeexplore.ieee.org/abstract/document/8255551)
- Isaac Gym, High Performance GPU-Based Physics Simulation For Robot Learning (2021), [paper link](https://arxiv.org/abs/2108.10470)
...
## Hardware / Actuators & Modeling Challenges
- ANYmal, ANYmal: A Highly Mobile and Dynamic Quadrupedal Robot, [paper link](https://www.research-collection.ethz.ch/handle/20.500.11850/118642)

## Learned Actuator Models & High-Performance Platforms
- Learning agile and dynamic motor skills, Learning agile and dynamic motor skills for legged robots (Science Robotics), [paper link](https://www.science.org/doi/10.1126/scirobotics.aau5872)
- Learning to Walk in Minutes, Learning to Walk in Minutes Using Massively Parallel Deep RL (CoRL), [paper link](https://proceedings.mlr.press/v164/rudin22a/rudin22a.pdf)
- ANYmal Parkour, ANYmal Parkour: Learning Agile Navigation for Quadrupedal Robots (Science Robotics), [paper link](https://www.science.org/doi/10.1126/scirobotics.adi7566)
...
# ToDo
1. Add the figures and table to this README.
2. Re-organize the repo based on the structure of our paper.
3. Add content to the new structure based on the format below:
